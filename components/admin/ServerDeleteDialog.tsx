      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 p-6">
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            rows={5}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none text-gray-900 bg-white placeholder:text-gray-400"
            disabled={isDeleting}
          />
