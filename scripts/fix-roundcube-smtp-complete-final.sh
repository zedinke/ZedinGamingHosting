...
# Roundcube SMTP config teljes javítása (auth teljesen kikapcsolva)

cd /usr/share/roundcube/config

# Biztonsági mentés
cp config.inc.php config.inc.php.bak3
...
echo "✅ Config teljesen újraírva (SMTP auth teljesen eltávolítva)"
