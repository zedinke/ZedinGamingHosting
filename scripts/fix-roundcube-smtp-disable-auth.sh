...
# Roundcube SMTP config javítása (auth teljesen kikapcsolva)
...
$config['smtp_user'] = false;
$config['smtp_pass'] = false;
...
echo "✅ Config újraírva (smtp_auth_type = false, smtp_user = false, smtp_pass = false)"
