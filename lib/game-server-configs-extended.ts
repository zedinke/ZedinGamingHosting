...
export const EXTENDED_GAME_SERVER_CONFIGS: Partial<Record<GameType, GameServerConfig>> = {
  TEAM_FORTRESS_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 232250 validate +quit
    `,
  ...
  HALF_LIFE_2_DEATHMATCH: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 320 validate +quit
    `,
  ...
  COUNTER_STRIKE_SOURCE: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 232330 validate +quit
    `,
  ...
  DAY_OF_DEFEAT_SOURCE: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 232290 validate +quit
    `,
  ...
  PORTAL_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 620 validate +quit
    `,
  ...
  LEFT_4_DEAD: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 222840 validate +quit
    `,
  ...
  DEAD_BY_DAYLIGHT: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 381210 validate +quit
    `,
  ...
  READY_OR_NOT: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1144200 validate +quit
    `,
  ...
  HELLDIVERS_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 553850 validate +quit
    `,
  ...
  WAR_THUNDER: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 236390 validate +quit
    `,
  ...
  DESTINY_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1086940 validate +quit
    `,
  ...
  STARDEW_VALLEY: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 413150 validate +quit
    `,
  ...
  FORZA_HORIZON_5: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1551360 validate +quit
    `,
  ...
  BLACK_MYTH_WUKONG: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 2358720 validate +quit
    `,
  ...
  BATTLEFIELD_2042: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1517290 validate +quit
    `,
  ...
  CALL_OF_DUTY_WARZONE: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1985810 validate +quit
    `,
  ...
  APEX_LEGENDS: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1172470 validate +quit
    `,
  ...
  PUBG_BATTLEGROUNDS: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 578080 validate +quit
    `,
  ...
  ELDEN_RING: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1245620 validate +quit
    `,
  ...
  RED_DEAD_REDEMPTION_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1174180 validate +quit
    `,
  ...
  CYBERPUNK_2077: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1091500 validate +quit
    `,
  ...
  DEAD_ISLAND_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 934940 validate +quit
    `,
  ...
  DYING_LIGHT_2: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 534380 validate +quit
    `,
  ...
  THE_LAST_OF_US: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1888930 validate +quit
    `,
  ...
  HORIZON_ZERO_DAWN: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1151640 validate +quit
    `,
  ...
  GOD_OF_WAR: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1593500 validate +quit
    `,
  ...
  SPIDER_MAN: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1817070 validate +quit
    `,
  ...
  GHOST_OF_TSUSHIMA: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 2215430 validate +quit
    `,
  ...
  DEATH_STRANDING: {
    ...
    installScript: `
      ...
      ./steamcmd.sh +force_install_dir /opt/servers/{serverId} +login anonymous +app_update 1190460 validate +quit
    `,
