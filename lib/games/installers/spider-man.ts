...
# Spider-Man szerver telepítése globális SteamCMD-vel
echo "Installing Spider-Man dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Spider-Man" ] || [ -d "$SERVER_DIR/SpiderMan" ]; then
