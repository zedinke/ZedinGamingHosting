/**
 * Stardew Valley telepítő script
 */
...
# Stardew Valley szerver telepítése globális SteamCMD-vel
echo "Installing Stardew Valley dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Stardew Valley" ] || [ -d "$SERVER_DIR/StardewValley" ]; then
