/**
 * PUBG: Battlegrounds telepítő script
 */
...
# PUBG: Battlegrounds szerver telepítése globális SteamCMD-vel
echo "Installing PUBG: Battlegrounds dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/PUBG" ] || [ -d "$SERVER_DIR/PUBG" ]; then
