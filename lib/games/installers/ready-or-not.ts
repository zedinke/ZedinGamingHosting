...
# Ready or Not szerver telepítése globális SteamCMD-vel
echo "Installing Ready or Not dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Ready Or Not Dedicated Server" ] || [ -d "$SERVER_DIR/ReadyOrNot" ]; then
