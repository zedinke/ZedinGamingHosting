/**
 * Team Fortress 2 telepítő script
 */
...
# Team Fortress 2 szerver telepítése globális SteamCMD-vel
echo "Installing Team Fortress 2 dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/tf" ] || [ -d "$SERVER_DIR/steamapps/common/Team Fortress 2 Dedicated Server" ]; then
