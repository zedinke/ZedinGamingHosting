/**
 * Ghost of Tsushima telepítő script
 */
...
# Ghost of Tsushima szerver telepítése globális SteamCMD-vel
echo "Installing Ghost of Tsushima dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Ghost of Tsushima" ] || [ -d "$SERVER_DIR/GhostOfTsushima" ]; then
