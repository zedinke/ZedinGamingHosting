/**
 * Call of Duty: Warzone telepítő script
 */
...
# Call of Duty: Warzone szerver telepítése globális SteamCMD-vel
echo "Installing Call of Duty: Warzone dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Call of Duty Warzone" ] || [ -d "$SERVER_DIR/CoDWarzone" ]; then
