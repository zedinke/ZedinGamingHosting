...
# Apex Legends szerver telepítése globális SteamCMD-vel
echo "Installing Apex Legends dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/ApexLegends" ] || [ -d "$SERVER_DIR/steamapps/common/Apex Legends" ]; then
