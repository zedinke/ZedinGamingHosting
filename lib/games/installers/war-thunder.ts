...
# War Thunder szerver telepítése globális SteamCMD-vel
echo "Installing War Thunder dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/War Thunder" ] || [ -d "$SERVER_DIR/WarThunder" ]; then
