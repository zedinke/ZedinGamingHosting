/**
 * Horizon Zero Dawn telepítő script
 */
...
# Horizon Zero Dawn szerver telepítése globális SteamCMD-vel
echo "Installing Horizon Zero Dawn dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Horizon Zero Dawn" ] || [ -d "$SERVER_DIR/HorizonZeroDawn" ]; then
