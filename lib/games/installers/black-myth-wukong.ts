...
# Black Myth: Wukong szerver telepítése globális SteamCMD-vel
echo "Installing Black Myth: Wukong dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Black Myth Wukong" ] || [ -d "$SERVER_DIR/BlackMythWukong" ]; then
