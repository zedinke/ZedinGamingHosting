/**
 * Death Stranding telepítő script
 */
...
# Death Stranding szerver telepítése globális SteamCMD-vel
echo "Installing Death Stranding dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Death Stranding" ] || [ -d "$SERVER_DIR/DeathStranding" ]; then
