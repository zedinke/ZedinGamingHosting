/**
 * Counter-Strike: Source telepítő script
 */
...
# Counter-Strike: Source szerver telepítése globális SteamCMD-vel
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/cstrike" ] || [ -d "$SERVER_DIR/steamapps/common/Counter-Strike Source Dedicated Server" ]; then
