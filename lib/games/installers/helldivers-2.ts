...
# Helldivers 2 szerver telepítése globális SteamCMD-vel
echo "Installing Helldivers 2 dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Helldivers 2" ] || [ -d "$SERVER_DIR/Helldivers2" ]; then
