/**
 * The Last of Us telepítő script
 */
...
# The Last of Us szerver telepítése globális SteamCMD-vel
echo "Installing The Last of Us dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/The Last of Us" ] || [ -d "$SERVER_DIR/TheLastOfUs" ]; then
