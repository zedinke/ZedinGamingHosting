...
# Portal 2 szerver telepítése globális SteamCMD-vel
echo "Installing Portal 2 dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/portal2" ] || [ -d "$SERVER_DIR/steamapps/common/Portal 2 Dedicated Server" ]; then
...
mkdir -p "$SERVER_DIR/portal2/cfg"
chown -R root:root "$SERVER_DIR"
chmod -R 755 "$SERVER_DIR"
`;
