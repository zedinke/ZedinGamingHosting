...
# God of War szerver telepítése globális SteamCMD-vel
echo "Installing God of War dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/God of War" ] || [ -d "$SERVER_DIR/GodOfWar" ]; then
