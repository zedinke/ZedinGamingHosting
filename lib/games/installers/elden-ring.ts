...
# Elden Ring szerver telepítése globális SteamCMD-vel
echo "Installing Elden Ring dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/ELDEN RING" ] || [ -d "$SERVER_DIR/EldenRing" ]; then
