/**
 * Dead by Daylight telepítő script
 */
...
# Dead by Daylight szerver telepítése globális SteamCMD-vel
echo "Installing Dead by Daylight dedicated server..."
...
while [ $RETRY_COUNT -lt $MAX_RETRIES ]; do
  ...
  if [ -d "$SERVER_DIR/steamapps/common/Dead by Daylight Dedicated Server" ] || [ -d "$SERVER_DIR/DeadByDaylight" ]; then
